...
form.addEventListener("submit", async (event) => {
  ...
  open.style.right = "55px";
  open.style.top = "1%";
  open.onclick = function() {
      if (document.getElementById("iframe").contentWindow.location.href!="about:blank"){
          var win = window.open();
          win.document.open();
          win.document.write(`<iframe src="${document.getElementById("iframe").contentWindow.location.href}" style="position:fixed;width:100vw;height:100vh;top:0px;left:0px;right:0px;bottom:0px;z-index:2147483647;background-color:white;border:none;"></iframe>`);
          win.document.close();
                }
            };
